            ...
            while global_frame < total:
                ...
                if available > 0 and now >= next_frame_wall:
                    ...
                    if now - last_gui_update > 0.2:
                        ...
                        # Show every 10th frame in the preview so the user
                        # can see what is being recorded (persists until next update)
                        if frame_cb and len(all_frames) > 0 and (global_frame - 1) % 10 == 0:
